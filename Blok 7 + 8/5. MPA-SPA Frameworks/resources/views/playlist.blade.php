            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input form="saveChanges" type="text" name="playlistName" class="form-control mb-3" id="playlistName"
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" id="saveChanges" action="/playlist/{{ $playlist->id }}/update">
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="managePlaylistFormInput1">Playlist name</label>
                            <input class="form-control mb-3" id="managePlaylistFormInput1" placeholder="Playlist 1" value="{{ $playlist->name }}">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <form method="POST" action="/playlist/{{ $playlist->id }}/update">
                        @csrf
                        <button type="submit" class="btn btn-primary">
                            <h5 class="m-0">Save changes</h5>
                        </button>
